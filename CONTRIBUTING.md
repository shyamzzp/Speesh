# Contributing to Speesh

Thank you for your interest in contributing to Speesh! This guide will help you get started with contributing to this open source speech-to-text application.

## ⚠️ Feature Freeze

**Speesh is currently undergoing a feature freeze.** If you are submitting a PR which is a new feature that the community has not asked for, it will be rejected. If the community has asked for it, or you have explicitly gathered support, it may still be considered.
...
Speesh aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Speesh.git
   cd Speesh
   ```
...
3. **Add upstream remote**:
   ...
   ```bash
   git remote add upstream git@github.com:shyamzzp/Speesh.git
   ```
...
Speesh follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/shyamzzp/Speesh/issues](https://github.com/shyamzzp/Speesh/issues)
2. **Check discussions** at [github.com/shyamzzp/Speesh/discussions](https://github.com/shyamzzp/Speesh/discussions)
...
1. **Search existing discussions** at [github.com/shyamzzp/Speesh/discussions](https://github.com/shyamzzp/Speesh/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/shyamzzp/Speesh/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/shyamzzp/Speesh/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/shyamzzp/Speesh/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with Speesh's philosophy
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/shyamzzp/Speesh/issues)
   - [Closed issues](https://github.com/shyamzzp/Speesh/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/shyamzzp/Speesh/pulls)
   - [Closed PRs](https://github.com/shyamzzp/Speesh/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/shyamzzp/Speesh/discussions)
   - Link to that discussion in your PR

3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure Speesh stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping Speesh the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
7. **Create a Pull Request**:
   - Go to the [Speesh repository](https://github.com/shyamzzp/Speesh)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/shyamzzp/Speesh/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/shyamzzp/Speesh/discussions)
- **Email**: Reach out at [contact@speesh.computer](mailto:contact@speesh.computer)

## 📜 License

By contributing to Speesh, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Speesh!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
