; Custom NSIS template for Speesh with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Speesh for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Speesh releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Speesh Portable Mode"
    FileClose $0
