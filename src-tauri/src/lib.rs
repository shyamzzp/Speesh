...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::speesh_keys::start_speesh_keys_recording,
            shortcut::speesh_keys::stop_speesh_keys_recording,
    ...
    // Single-instance forwards CLI args to an already-running Speesh and exits.
